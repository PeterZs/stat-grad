...
head_template_noeye = f'{CODE_BASE}/assets/flame_template_render.obj'
head_template_color = f'{CODE_BASE}/assets/head_template_color.obj'
head_template_ply = f'{CODE_BASE}/assets/test_rigid.ply'

EYEHOLE_MASK = f'{CODE_BASE}/assets/eyehole_index.npy'
MOUTHHOLE_MASK = f'{CODE_BASE}/assets/flame_mouthhole_index.npy'
